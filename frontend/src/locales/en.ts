export default {
  ...
  batchImport: {
    linksLabel: "Paste links (one per line)",
    placeholder: "vless://...\nvmess://...\ntrojan://...\nss://...\nsocks5://...",
    result: "Result",
    success: "success",
    failed: "failed",
  ...
  nodeTest: {
    ...
    queryIP: "Query Landing IP",
    total: "Total",
    available: "Available",
    failed: "Failed",
    avgLatency: "Avg Latency",
    clickStart: "Click 'Start Test' to begin testing all nodes.",
    export: "Export",
  ...
  subscription: {
    ...
    intervalHint: "0 = manual only",
    nodes: "nodes",
    refresh: "Refresh",
    lastUpdate: "Last update",
    confirmDelete: "Are you sure you want to delete this subscription? All imported nodes will also be deleted.",
    viewNodes: "View Nodes",
    viewSelectedNodes: "View Selected Nodes",
  },
}
